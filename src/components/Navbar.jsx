    ...
    <div className='bg-slate-100 py-1 relative'>
      ...
      className='bg-slate-50 scr lg:hidden'>
        <ul className='flex flex-col space-y-10 bg-slate-50 w-[300px] h-[950px] items-center pt-36 absolute text-2xl font-semibold top-0 z-30 right-0'>
          ...
          <li className='hover:text-red-500 cursor-pointer transition-all'>Layers</li>
          <li className='hover:text-red-500 cursor-pointer transition-all'>Benefits</li>
          <button className='bg-red-500 text-white px-4 py-2 rounded-full'>Contact Us</button>
        <X
        onClick={NavHandler}
