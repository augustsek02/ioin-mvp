...
const Hero = () => {
    return (
        <div className='bg-[#ffffff] relative z-10 overflow-x-hidden lg:overflow-x-visible'>
            <div className='max-w-7xl  mx-auto'>
                <div className='flex flex-col  lg:flex-row gap-12 lg:gap-6 h-screen lg:h-[650px] lg:items-center lg:justify-center lg:pt-0 pt-12'>
                    ...
                    <div className='lg:w-1/2 flex  flex-col px-8 space-y-5 justify-center '>
                        ...
                        initial="hidden"
                        animate="visible"
                        className='text-blue-500 text-lg lg:text-xl'>INTELLIGENT PARKING, AUTOMATED _____</motion.h3>
                        <motion.h1 
                        variants={FadeRight(0.9)}
                        initial="hidden"
                        animate="visible"
                        className='text-4xl lg:text-6xl font-bold text-black'>Parking Ecosystem
 <span className='text-blue-500'> Think For Itself</span></motion.h1>
                        <motion.p
                        ...
                        <div className='flex gap-3'>
                            ...
                            initial="hidden"
                            animate="visible"
                            className='bg-blue-500 text-white px-3 lg:px-4 py-2 rounded-full flex items-center font-semibold'>Explore How It Works<ChevronRight /></motion.button>
                            <motion.button
